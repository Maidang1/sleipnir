...
export function InstallCommand({ className }: { className?: string }) {
  ...
  return (
    <div
      className={cn(
        'flex max-w-2xl items-start gap-2 rounded-lg border border-border bg-muted/70 px-3 py-2',
        className,
      )}
    >
      <pre className="m-0 min-w-0 flex-1 font-mono text-[12.5px] leading-6 wrap-break-word whitespace-pre-wrap text-foreground">
