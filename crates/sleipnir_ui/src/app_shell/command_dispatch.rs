...
impl AppShell {
    ...
    pub(crate) fn dispatch_command(
        ...
        match id {
            ...
            CommandId::Find => self.open_find(window, cx),
            CommandId::ToggleCommandPalette => self.open_palette(window, cx),
            ...
            CommandId::ToggleHistorySearch => self.toggle_history_search(window, cx),
